	...
	<div class="swipe">
		<div class="swipe-menu">
			<ul class="links">
				...
				<li><a class="<?php if (isset($this->request->get['route']) && $this->request->get['route']=="account/sign_up")  {echo "active";}?>" href="<?php echo $signup; ?>"><i class="fa fa-user"></i><?php echo "Melde Dich an und verkaufe Deine Artikel an Deine Freunde"; ?></a></li> 
			...
			<ul class="foot foot-3">
				<li><a href="<?php echo $signup; ?>"><?php echo "Shop Konto erstellen"; ?></a></li>
				<li><a href="<?php echo $order; ?>"><?php echo "Order"; ?></a></li>
				<li><a href="<?php echo $newsletter; ?>"><?php echo "Newsletter"; ?></a></li>
			</ul>
		</div>
	</div>
	<div id="page">
				...
				<div class="container">
					<div class="row">
						<div class="col-sm-12">
							...
							<ul class="links">
								<?php if (!isset($this->request->get['route'])) { $route='active'; }  else {$route='';}?> <li class="first"><a class="<?php echo $route; if (isset($this->request->get['route']) && $this->request->get['route']=="common/home") {echo "active";} ?>" href="<?php echo $home; ?>"><i class="fa fa-home"></i><?php echo $text_home; ?></a></li>
								<li><a class="<?php if (isset($this->request->get['route']) && $this->request->get['route']=="account/sign_up")  {echo "active";}?>" href="<?php echo $signup; ?>"><i class="fa fa-user"></i><?php echo "Registrieren und Verkaufen"; ?></a></li> 
				...
				<div class="container">
					<div class="row">
						<div class="col-sm-12">
							<div id="search">
								<div class="inner">
									<div class="button-search"><i class="fa fa-search"></i><?php echo $text_search; ?></div>
		...
		<!-- Container -->
			<div id="container">
				...
				<div class="container">
					<?php if (!empty($error)) { ?>
					<div class="warning"><?php echo $error ?><img src="catalog/view/theme/theme436/image/close-1.png" alt="" class="close" /></div>
					<?php } ?>
