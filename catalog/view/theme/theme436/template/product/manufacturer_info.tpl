  ...
  <div class="product-grid">
	<ul class="row">
	  ...
	  <div class="cart-button">
				...
				<div class="wishlist"><a class="tooltip-1 " title="<?php echo $button_wishlist; ?>"  onclick="addToWishList('<?php echo $product['product_id']; ?>');"><i class="fa fa-star-o"></i></a></div>
				<div class="compare"><a class="tooltip-1" title="<?php echo $button_compare; ?>"  onclick="addToCompare('<?php echo $product['product_id']; ?>');"><i class="fa fa-signal"></i></a></div>
				<div class="clear"></div>
			</div>
