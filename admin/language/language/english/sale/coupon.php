...
$_['error_code']          = 'Code must be between 3 and 10 characters!';
			...
			$_['error_coupon_product']= 'Please specify products the coupon need to apply!';
			$_['error_warning']       = 'Warning: You do not have permission to modify this coupon!';
			$_['entry_vendor_name']	  = 'Vendor Name:';
			$_['entry_product1']      = 'Products:<br /><span class="help">Choose specific products the coupon will apply to.</span>';
