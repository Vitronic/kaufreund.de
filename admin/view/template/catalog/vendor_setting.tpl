...
<div class="box">
  ...
  <div class="content">
    <div id="tabs" class="htabs"><a href="#tab-email"><?php echo $tab_mail_setting; ?></a><a href="#tab-catalog"><?php echo $tab_catalog; ?></a><a href="#tab-sales"><?php echo $tab_sales; ?></a><a href="#tab-store"><?php echo $tab_store; ?></a><a href="#tab-notification"><?php echo $tab_notification; ?></a><a href="#tab-signup"><?php echo $tab_signup; ?></a></div>
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
	  ...
	  <div id="tab-catalog">
		  ...
		  <tr>
          <td><?php echo $entry_vendor_product_edit_approval; ?></td>
          <td><?php if ($vendor_product_edit_approval) { ?>
            <input type="radio" name="vendor_product_edit_approval" value="1" checked="checked" />
            <?php echo $text_yes; ?>
            <input type="radio" name="vendor_product_edit_approval" value="0" />
            <?php echo $text_no; ?>
            <?php } else { ?>
            <input type="radio" name="vendor_product_edit_approval" value="1" />
            <?php echo $text_yes; ?>
            <input type="radio" name="vendor_product_edit_approval" value="0" checked="checked" />
            <?php echo $text_no; ?>
            <?php } ?></td>
           </tr>
		  <tr>
          <td><?php echo $entry_bulk_products_activation; ?></td>
          <td><?php if ($bulk_products_activation) { ?>
            <input type="radio" name="bulk_products_activation" value="1" checked="checked" />
            <?php echo $text_yes; ?>
            <input type="radio" name="bulk_products_activation" value="0" />
            <?php echo $text_no; ?>
            <?php } else { ?>
            <input type="radio" name="bulk_products_activation" value="1" />
            <?php echo $text_yes; ?>
            <input type="radio" name="bulk_products_activation" value="0" checked="checked" />
            <?php echo $text_no; ?>
            <?php } ?></td>
           </tr>
		  <tr>
	  ...
	  <div id="tab-sales">
          ...
          <td><?php if ($sales_order_history) { ?>
		   ...
		   <tr>
		   <td><?php echo $entry_allow_notification; ?></td>
           <td><?php if ($sales_order_allow_notification) { ?>
            <input type="radio" name="sales_order_allow_notification" value="1" checked="checked" />
            <?php echo $text_yes; ?>
            <input type="radio" name="sales_order_allow_notification" value="0" />
            <?php echo $text_no; ?>
            <?php } else { ?>
            <input type="radio" name="sales_order_allow_notification" value="1" />
            <?php echo $text_yes; ?>
            <input type="radio" name="sales_order_allow_notification" value="0" checked="checked" />
            <?php echo $text_no; ?>
            <?php } ?></td>
           </tr>
		   <tr>
            <td><?php echo $entry_order_status_availability; ?></td>
            <td><div class="scrollbox">
                <?php $class = 'odd'; ?>
                  <?php foreach ($order_statuses as $order_status) { ?>
                  <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
                  <div class="<?php echo $class; ?>">
					<?php if ($sales_order_status_availability) { ?>
						<?php if (in_array($order_status['order_status_id'], $sales_order_status_availability)) { ?>
							<input type="checkbox" name="sales_order_status_availability[]" value="<?php echo $order_status['order_status_id']; ?>" checked="checked" /><?php echo $order_status['name']; ?>
						<?php } else { ?>
							<input type="checkbox" name="sales_order_status_availability[]" value="<?php echo $order_status['order_status_id']; ?>" /><?php echo $order_status['name']; ?>
						<?php } ?>
					<?php } else { ?>
						<input type="checkbox" name="sales_order_status_availability[]" value="<?php echo $order_status['order_status_id']; ?>" /><?php echo $order_status['name']; ?>
					<?php } ?>
	  ...
	  <div id="tab-store">
        <table class="form">
		<tr>
          <td><?php echo $entry_multi_store_activated; ?></td>
          <td><?php if ($multi_store_activated) { ?>
            <input type="radio" name="multi_store_activated" value="1" checked="checked" />
            <?php echo $text_yes; ?>
            <input type="radio" name="multi_store_activated" value="0" />
            <?php echo $text_no; ?>
            <?php } else { ?>
            <input type="radio" name="multi_store_activated" value="1" />
            <?php echo $text_yes; ?>
            <input type="radio" name="multi_store_activated" value="0" checked="checked" />
            <?php echo $text_no; ?>
            <?php } ?></td>
           </tr>
		<tr>
          <td><?php echo $entry_multi_payment_gateway; ?></td>
          <td><?php if ($multi_payment_gateway_status) { ?>
            <input type="radio" name="multi_payment_gateway_status" value="1" checked="checked" />
            <?php echo $text_yes; ?>
            <input type="radio" name="multi_payment_gateway_status" value="0" />
            <?php echo $text_no; ?>
            <?php } else { ?>
            <input type="radio" name="multi_payment_gateway_status" value="1" />
            <?php echo $text_yes; ?>
            <input type="radio" name="multi_payment_gateway_status" value="0" checked="checked" />
            <?php echo $text_no; ?>
            <?php } ?></td>
        </tr>		
		</table>
	  ...
	  <div id="tab-notification">
        <table class="form">
		<tr>
            <td><?php echo $entry_product_notification; ?></td>
			 <td><?php if ($product_notification) { ?>
            <input type="radio" name="product_notification" value="1" checked="checked" />
            <?php echo $text_yes; ?>
            <input type="radio" name="product_notification" value="0" />
            <?php echo $text_no; ?>
            <?php } else { ?>
            <input type="radio" name="product_notification" value="1" />
            <?php echo $text_yes; ?>
            <input type="radio" name="product_notification" value="0" checked="checked" />
            <?php echo $text_no; ?>
            <?php } ?></td>
        </tr>
		<tr>
	  ...
	  <div id="tab-signup">
          ...
          <td><?php if ($signup_auto_approval) { ?>
		   ...
		   <tr>
          <td><?php echo $entry_show_plan; ?></td>
          <td><?php if ($signup_show_plan) { ?>
            <input type="radio" name="signup_show_plan" value="1" checked="checked" />
            <?php echo $text_yes; ?>
            <input type="radio" name="signup_show_plan" value="0" />
            <?php echo $text_no; ?>
            <?php } else { ?>
            <input type="radio" name="signup_show_plan" value="1" />
            <?php echo $text_yes; ?>
            <input type="radio" name="signup_show_plan" value="0" checked="checked" />
            <?php echo $text_no; ?>
            <?php } ?></td>
           </tr>
		  <tr>
          <td><?php echo $entry_paypal_sandbox; ?></td>
          <td><?php if ($signup_paypal_sandbox) { ?>
            <input type="radio" name="signup_paypal_sandbox" value="1" checked="checked" />
            <?php echo $text_yes; ?>
            <input type="radio" name="signup_paypal_sandbox" value="0" />
            <?php echo $text_no; ?>
            <?php } else { ?>
            <input type="radio" name="signup_paypal_sandbox" value="1" />
            <?php echo $text_yes; ?>
            <input type="radio" name="signup_paypal_sandbox" value="0" checked="checked" />
            <?php echo $text_no; ?>
            <?php } ?></td>
           </tr>
		  <tr>
          <td><?php echo $entry_signup_paypal_email; ?></td>
          <td><input type="text" name="signup_paypal_email" value="<?php echo $signup_paypal_email; ?>" size="35" /></td>
          </tr>
		  ...
		  <?php foreach ($signup_commissions as $commission) { ?>
			...
			<?php if ($commission['commission_type'] == '0') { ?>
				<?php echo $commission['commission_name'] . ' (' . $commission['commission'] . '%) - ' . $commission['product_limit'] . $text_products; ?>
			<?php } elseif ($commission['commission_type'] == '1') { ?>
				<?php echo $commission['commission_name'] . ' (' . $commission['commission'] . ') - ' . $commission['product_limit'] . $text_products; ?>
			<?php } elseif ($commission['commission_type'] == '2') { ?>
				<?php $data = explode(':',$commission['commission']); ?>
				<?php echo $commission['commission_name'] . ' (' . $data[0] . '% + ' . $data[1] . ') - ' . $commission['product_limit'] . $text_products; ?>
			<?php } elseif ($commission['commission_type'] == '3') { ?>
				<?php $data = explode(':',$commission['commission']); ?>
				<?php echo $commission['commission_name'] . ' (' . $data[0] . ' + ' . $data[1] . '%) - ' . $commission['product_limit'] . $text_products; ?>
			<?php } elseif ($commission['commission_type'] == '4') { ?>
				<?php echo $commission['commission_name'] . ' (' . $this->currency->format($commission['commission'], $this->config->get('config_currency')) . ') - ' . $commission['product_limit'] . $text_products; ?>
