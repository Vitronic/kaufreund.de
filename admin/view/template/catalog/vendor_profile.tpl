...
<div id="content">
  ...
  <div class="content">
    <div id="tabs" class="htabs"><a href="#tab-general"><?php echo $tab_general; ?></a><a href="#tab-address"><?php echo $tab_address; ?></a><a href="#tab-finance"><?php echo $tab_finance; ?></a><?php if ($this->config->get('multi_store_activated')) { ?><a href="#tab-payment"><?php echo $tab_payment; ?></a><?php } ?></div>
