      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="form">
          ...
          <tr>
			...
			<tr><td><?php echo $txt_expired_date; ?></td>
				<td><input type="text" size="10" name="user_date_start" value="<?php echo $user_date_start; ?>" class="date" /> | <input type="text" size="10" name="user_date_end" value="<?php echo $user_date_end; ?>" class="date" /></td>
			</tr>
