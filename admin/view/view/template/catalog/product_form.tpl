...
<div id="content">
  ...
  <div class="box">
    ...
    <div class="content">
      <div id="tabs" class="htabs"><a href="#tab-general"><?php echo $tab_general; ?></a><a href="#tab-data"><?php echo $tab_data; ?></a><a href="#tab-vendor"><?php echo $tab_vendor; ?></a><a href="#tab-shipping"><?php echo $tab_shipping; ?></a><a href="#tab-links"><?php echo $tab_links; ?></a><a href="#tab-attribute"><?php echo $tab_attribute; ?></a><a href="#tab-option"><?php echo $tab_option; ?></a><a href="#tab-profile"><?php echo $tab_profile; ?></a><a href="#tab-discount"><?php echo $tab_discount; ?></a><a href="#tab-special"><?php echo $tab_special; ?></a><a href="#tab-image"><?php echo $tab_image; ?></a><a href="#tab-reward"><?php echo $tab_reward; ?></a><a href="#tab-design"><?php echo $tab_design; ?></a></div>
...
//--></script> 
			...
			function getVendors() {
				$.ajax({
					...
					dataType: 'json',
					beforeSend: function() {
						$('select[name=\'vendor\']').after('<span class="wait">&nbsp;<img src="view/image/loading.gif" alt="" /></span>');
					},
					...
					success: function(data) {
						if (data['vendor_name']) {
							$("#company").val(data['vendor_name']);
							$("#vname").val(data['vname']);
							$("#telephone").val(data['telephone']);
							$("#fax").val(data['fax']);
							$("#email").val(data['email']);
							$("#paypal_email").val(data['paypal_email']);
							$("#vendor_description").val(data['vendor_description']);
							$("#vendor_address").val(data['address']);
							$("#vendor_country_zone").val(data['zone_name'][0] + ', ' + data['country_name'][0]);
