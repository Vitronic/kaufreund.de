      ...
      <form action="" method="post" enctype="multipart/form-data" id="form">
        <table class="list" id="history">
          <thead>
            <tr>
	            <td></td>
                <td class="left" width="150px"><?php echo $column_vendor_name; ?></td>
                <td class="left" width="900px"><?php echo $column_order_product; ?></td>
                <td class="right" width="150px"><?php echo $column_payment_amount; ?> (<?php echo $this->config->get('config_currency'); ?>)</td>
                <td class="left" width="100px"><?php echo $column_payment_date; ?></td>
            </tr>
          </thead>
          <tbody>
             <?php if ($histories) { ?>
