...
class ControllerCommonHeader extends Controller {
	protected function index() {
		...
		$this->data['text_product'] = $this->language->get('text_product'); 
			...
			$this->data['text_contract_history'] = $this->language->get('text_contract_history');
			...
			$this->data['text_vendor_tools'] = $this->language->get('text_vendor_tools');
			$this->data['text_quicker_status_modifier'] = $this->language->get('text_quicker_status_modifier');
			$this->data['text_contract_status_modifier'] = $this->language->get('text_contract_status_modifier');
		...
		if (!$this->user->isLogged() || !isset($this->request->get['token']) || !isset($this->session->data['token']) || ($this->request->get['token'] != $this->session->data['token'])) {
			...
			$this->data['opt2ven'] = $this->url->link('catalog/opt2ven', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['attr2ven'] = $this->url->link('catalog/attr2ven', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['attr2ven_group'] = $this->url->link('catalog/attr2ven_group', 'token=' . $this->session->data['token'], 'SSL');
			...
			$this->data['prostatctrl'] = $this->url->link('catalog/prostatctrl', 'token=' . $this->session->data['token'], 'SSL');
			...
			$this->data['ven_coupon'] = $this->url->link('sale/coup2ven', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['contstatctrl'] = $this->url->link('sale/contstatctrl', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['contract_history'] = $this->url->link('sale/contract_history', 'token=' . $this->session->data['token'], 'SSL');
			...
			if ($this->user->getExpireDate()!= '0000-00-00') { 
				$this->data['expiration_date'] = '<span style="color:white;background-color:#4AA02C;padding:1px 5px 1px 5px;border-radius: 3px 3px 3px 3px">' . $this->user->getExpireDate() . '</span>';
			} else {
				$this->data['expiration_date'] = false;
			} 
