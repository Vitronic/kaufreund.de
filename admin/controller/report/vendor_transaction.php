...
class ControllerReportVendorTransaction extends Controller { 
	public function index() {  
		...
		$discount_coupons = $this->model_report_vendor_transaction->getCouponTotal($data);
		$coupon_amount = 0;
		...
		foreach ($results as $result) {
			$this->data['orders'][] = array(
				...
				'product_name'  => $result['product_name'] . '<br/><b>(' . $this->model_report_vendor_transaction->getVendorName($result['vendor_id']) . ')</b>',
