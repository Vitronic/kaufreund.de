...
class ControllerCatalogPro2Ven extends Controller {
	private $error = array(); 
  	...
  	protected function getForm() {
		...
		$this->data['entry_shipping_geozone'] = $this->language->get('entry_shipping_geozone');
		...
		/**/
		if (isset($this->request->get['product_id'])) {
			foreach ($this->model_catalog_pro2ven->getProductDescriptions($this->request->get['product_id']) as $pdname) {
		...
		if (isset($this->request->post['product_category'])) {
			...
			$categories = $this->model_catalog_pro2ven->getProductCategories($this->request->get['product_id']);
		} else {
			$categories = array();
		}
		...
		if (isset($this->request->post['product_filter'])) {
			...
			$filters = $this->model_catalog_pro2ven->getProductFilters($this->request->get['product_id']);
		} else {
			$filters = array();
		}
		...
		if (isset($this->request->post['product_attribute'])) {
			...
			$product_attributes = $this->model_catalog_pro2ven->getProductAttributes($this->request->get['product_id']);
		} else {
		...
		if (isset($this->request->post['product_shipping'])) {
			$this->data['product_shippings'] = $this->request->post['product_shipping'];
		} elseif (isset($this->request->get['product_id'])) {
			$this->data['product_shippings'] = $this->model_catalog_pro2ven->getProductShippings($this->request->get['product_id']);
		} else {
			$this->data['product_shippings'] = array();
		}
		...
		if (isset($this->request->post['product_download'])) {
			...
			$product_downloads = $this->model_catalog_pro2ven->getProductDownloads($this->request->get['product_id']);
		} else {
		...
		foreach ($product_downloads as $download_id) {
			$download_info = $this->model_catalog_down2ven->getDownload($download_id);
	...
	public function manufacturerAutocomplete() {
		...
		if (isset($this->request->get['filter_name'])) {
			...
			$results = $this->model_catalog_pro2ven->getManufacturers($data);
	...
	public function filterAutocomplete() {
		...
		if (isset($this->request->get['filter_name'])) {
			...
			$filters = $this->model_catalog_pro2ven->getFilters($data);
	...
	public function add_edit_notification($pmode = true,$pname) {
		...
		$vendor_data = $this->model_catalog_pro2ven->getVendorName($this->user->getId());
