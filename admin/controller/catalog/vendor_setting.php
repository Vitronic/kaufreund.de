...
class ControllerCatalogVendorSetting extends Controller {
	...
	public function index() {   
		...
		$this->data['entry_order_status_availability'] = $this->language->get('entry_order_status_availability');
		...
		$this->data['entry_vendor_product_edit_approval'] = $this->language->get('entry_vendor_product_edit_approval');
		$this->data['entry_bulk_products_activation'] = $this->language->get('entry_bulk_products_activation');
		/*add*/
		...
		$this->data['entry_paypal_sandbox'] = $this->language->get('entry_paypal_sandbox');
		$this->data['entry_show_plan'] = $this->language->get('entry_show_plan');
		$this->data['entry_product_notification'] = $this->language->get('entry_product_notification');
		/*add*/
		...
		$this->data['entry_allow_notification'] = $this->language->get('entry_allow_notification');
		$this->data['entry_multi_store_activated'] = $this->language->get('entry_multi_store_activated');
		$this->data['entry_multi_payment_gateway'] = $this->language->get('entry_multi_payment_gateway');
		...
		$this->data['entry_signup_paypal_email'] = $this->language->get('entry_signup_paypal_email');
		...
		$this->data['tab_notification'] = $this->language->get('tab_notification');
		...
		if (isset($this->request->post['vendor_product_edit_approval'])) {
			$this->data['vendor_product_edit_approval'] = $this->request->post['vendor_product_edit_approval'];
		} else {
			$this->data['vendor_product_edit_approval'] = $this->config->get('vendor_product_edit_approval');
		}
		
		if (isset($this->request->post['bulk_products_activation'])) {
			$this->data['bulk_products_activation'] = $this->request->post['bulk_products_activation'];
		} else {
			$this->data['bulk_products_activation'] = $this->config->get('bulk_products_activation');
		}
		...
		if (isset($this->request->post['sales_order_status_availability'])) {
			$this->data['sales_order_status_availability'] = $this->request->post['sales_order_status_availability'];
		} else {
			$this->data['sales_order_status_availability'] = $this->config->get('sales_order_status_availability');
		}
		...
		if (isset($this->request->post['sales_order_allow_notification'])) {
			$this->data['sales_order_allow_notification'] = $this->request->post['sales_order_allow_notification'];
		} else {
			$this->data['sales_order_allow_notification'] = $this->config->get('sales_order_allow_notification');
		}
		
		if (isset($this->request->post['product_notification'])) {
			$this->data['product_notification'] = $this->request->post['product_notification'];
		} else {
			$this->data['product_notification'] = $this->config->get('product_notification');
		}
		
		if (isset($this->request->post['multi_store_activated'])) {
			$this->data['multi_store_activated'] = $this->request->post['multi_store_activated'];
		} else {
			$this->data['multi_store_activated'] = $this->config->get('multi_store_activated');
		}
		
		if (isset($this->request->post['multi_payment_gateway_status'])) {
			$this->data['multi_payment_gateway_status'] = $this->request->post['multi_payment_gateway_status'];
		} else {
			$this->data['multi_payment_gateway_status'] = $this->config->get('multi_payment_gateway_status');
		}
		...
		if (isset($this->request->post['signup_paypal_email'])) {
			$this->data['signup_paypal_email'] = $this->request->post['signup_paypal_email'];
		} else {
			$this->data['signup_paypal_email'] = $this->config->get('signup_paypal_email');
		}
		
		if (isset($this->request->post['signup_show_plan'])) {
			$this->data['signup_show_plan'] = $this->request->post['signup_show_plan'];
		} else {
			$this->data['signup_show_plan'] = $this->config->get('signup_show_plan');
		}
		
		if (isset($this->request->post['signup_paypal_sandbox'])) {
			$this->data['signup_paypal_sandbox'] = $this->request->post['signup_paypal_sandbox'];
		} else {
			$this->data['signup_paypal_sandbox'] = $this->config->get('signup_paypal_sandbox');
		}
		
		$this->load->model('catalog/vendor');
		$this->data['signup_commissions'] = $this->model_catalog_vendor->getCommissionLimits();
		
		if (isset($this->request->post['signup_commission'])) {
			$this->data['signup_commission'] = $this->request->post['signup_commission'];
		} else {
			$getCommission_id = explode(':',$this->config->get('signup_commission'));
			$this->data['signup_commission'] = $getCommission_id[0];
		}
