...
class ControllerCatalogProduct extends Controller {
	...
	protected function getForm() {
		...
		if (isset($this->request->post['location'])) {
			...
			/**/
			if (isset($this->request->get['product_id'])) {
				foreach ($this->model_catalog_product->getProductDescriptions($this->request->get['product_id']) as $pdname) {
			...
			if (isset($this->request->post['product_shipping'])) {
				...
				$this->data['product_shippings'] = $this->model_catalog_product->getProductShippings($this->request->get['product_id']);
			} else {
